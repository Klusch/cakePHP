 ...
 */
	public function add() {
		...
		$problemLocations = $this->Problem->ProblemLocation->find('list');
		$priorities = $this->Problem->Priority->find('list');
		$troubleshootings = $this->Problem->Troubleshooting->find('list');
		$cars = $this->Problem->Car->find('list');
		$this->set(compact('problemLocations', 'priorities', 'troubleshootings', 'cars'));
	}
