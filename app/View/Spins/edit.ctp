<div class="spins form">
<?php echo $this->Form->create('Spin'); ?>
	<fieldset>
		<legend><?php echo __('Edit Spin'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Spin.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Spin.id'))); ?></li>
