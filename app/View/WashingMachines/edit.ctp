...
<?php echo $this->Form->create('WashingMachine'); ?>
	<fieldset>
		<legend><?php echo __('Edit Washing Machine'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('WashingMachine.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('WashingMachine.id'))); ?></li>
