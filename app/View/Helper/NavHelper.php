...
class NavHelper extends AppHelper {
    ...
    public function fetch($part) {
        $result = '<header class="bg-dark" data-load="header.html">
                   </header>';
        return $result;
    }

//<header class="bg-dark" data-load="header.html"><div class="navigation-bar dark">
...
//            <span class="element-divider place-right"></span>
//            <div class="element place-right" title="GitHub Stars"><span class="icon-star"></span> <span class="github-watchers">3318</span></div>
//            <!--<span class="element-divider place-right"></span>-->
